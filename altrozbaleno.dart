...
class altrozbaleno extends StatelessWidget {
  altrozbaleno({Key key}) : super(key: key);
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image:  AssetImage("assets/compare/altroz.jpg"),
                            ),
                          ),
                                      ...
                                      child:  Column(
                                        children: <Widget>[
                                          Padding(padding: EdgeInsets.only(top: 10,left: 5),
                                            child: Text('1199 cc,3 cylinders Inline,4 Valves/Cylinder,DOHC',
                                              style: TextStyle(
                                                fontSize: 20,
                                                color: Colors.black,
                                                fontWeight: FontWeight.bold,
                                  ...
                                  Padding(padding: EdgeInsets.only(top: 10,left: 5),
                                    child: Container(
                                      ...
                                      child:  Column(
                                        children: <Widget>[
                                          Padding(padding: EdgeInsets.only(top: 10,left: 5),
                                            child: Text('1197 cc,4 cylinders Inline,4 Valves/Cylinder,DOHC',
                                              style: TextStyle(
                                                fontSize: 20,
                                                color: Colors.black,
                                                fontWeight: FontWeight.bold,
