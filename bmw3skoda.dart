...
class bmw3skoda extends StatelessWidget {
  bmw3skoda({Key key}) : super(key: key);
                      ...
                      child:Column(
                        children:<Widget> [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image:  AssetImage("assets/skoda.jpeg"),
                              ),
                            ),
                            // ignore: deprecated_member_use
                            child: FlatButton(
                                  ...
                                  Padding(padding: EdgeInsets.only(top: 10,left: 5),
                                    child: Container(
                                      ...
                                      child:  Column(
                                        children: <Widget>[
                                          Padding(padding: EdgeInsets.only(top: 10,left: 5),
                                            child: Text('999 cc,3 cylinders Inline,4 Valves/Cylinder,DOHC',
                                              style: TextStyle(
                                                fontSize: 20,
                                                color: Colors.black,
                                                fontWeight: FontWeight.bold,
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                Padding(padding: EdgeInsets.only(top: 12,left: 30),
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: <Widget>[
                                      Container(
