...
class crosscreta extends StatelessWidget {
  crosscreta({Key key}) : super(key: key);
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image:  AssetImage("assets/compare/cross.jpeg"),
                            ),
                          ),
                          child: FlatButton(
                              onPressed: (){},
                      ...
                      child:Column(
                        children:<Widget> [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image:  AssetImage("assets/compare/creta.jpeg"),
                              ),
                            ),
                            child: FlatButton(
                                onPressed: (){},
                                      ...
                                      Padding(padding: EdgeInsets.only(left: 5),
                                        child: Container(
                                          ...
                                          child:  Column(
                                            children: <Widget>[
                                              Padding(padding: EdgeInsets.only(top: 10,left: 5),
                                                child: Text('Common Fan Speed Control',
                                                  style: TextStyle(
                                                    fontSize: 20,
                                                    color: Colors.black,
                                                    fontWeight: FontWeight.bold,
